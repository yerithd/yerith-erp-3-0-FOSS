...
YERITH_ERP_3_0_BINARY_NAME="yerith-erp-3-0-${YERITH_ERP_3_0_LICENSE_TYPE}-configurations-data-ENGLISH"
...
if [ ! "$qsqlite3Flag" ]; then
	...
	${CP} ${YERITH_ERP_3_0_HOME_FOLDER}/yerith-erp-3-0-deployment-configuration-scripts/yerith-erp-3-0-system-local-configuration-ENGLISH.properties \
			"${OPT_INSTALLATION_TARGET_DIR}"
else
...
echo -e \"export YERITH_ERP_3_0_SYSTEM_LOCAL_CONFIGURATION_PROPERTY_FILE=/opt/${YERITH_ERP_3_0_BINARY_NAME}/yerith-erp-3-0-system-local-configuration-ENGLISH.properties\" >> /etc/environment
chmod go+rw /opt/${YERITH_SQL_BACKUP_FOLDER_NAME}
chmod go+rw /opt/${YERITH_ERP_3_0_BINARY_NAME}/yerith-erp-3-0-system-local-configuration-ENGLISH.properties"
