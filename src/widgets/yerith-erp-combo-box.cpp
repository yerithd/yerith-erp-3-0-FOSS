...
YerithComboBox::YerithComboBox(QWidget *parent):QComboBox(parent),
...
void YerithComboBox::find_AND_SET_CURRENT_INDEX_No_ADD_NEW_Item(const QString &a_text_TO_FIND_IN)
{
...
void YerithComboBox::find_AND_SET_CURRENT_INDEX(const QString &a_text_TO_FIND_IN)
{
    int ret_find = findText(a_text_TO_FIND_IN);
...
void YerithComboBox::find_AND_SET_CURRENT_INDEX_NOT_EDITABLE(const QString &
                                                             a_text_TO_FIND_IN)
{
    find_AND_SET_CURRENT_INDEX(a_text_TO_FIND_IN);
...
void YerithComboBox::addItems_AS_INITIALIZATION(const QString &
...
bool YerithComboBox::populateComboBoxRawString_APPEND(QString
                                                      aDBTableViewStringName,
                                                      QString aDBFieldColumn,
                                                      QString aConditionStr
                                                      /* = "" */)
 ...
 */
bool YerithComboBox::populateComboBoxWithout(const QList <
                                             int
